...
**Status**: Production Release (v0.2.0) - March 2026
...
```toml
[dependencies]
oxirs-ttl = { version = "0.2.0", features = ["rdf-12"] }
```
...
# With all features
oxirs-ttl = { version = "0.2.0", features = ["async-tokio", "parallel", "rdf-12"] }
```
