...
impl SimdEscaper {
    ...
    unsafe fn escape_literal_simd_impl(&self, value: &str) -> String {
        ...
        let mut result = String::with_capacity(len + escaped_count);
        ...
        while offset + 16 <= len {
            ...
            if mask == 0 {
                // No special characters in this chunk, copy directly
                result.push_str(&value[offset..offset + 16]);
                offset += 16;
            } else {
    ...
    fn needs_escaping_simd(&self, value: &str) -> bool {
        ...
        // Check remaining bytes
        self.needs_escaping_scalar(&value[offset..])
    }
    ...
    fn count_escaped_chars_simd(&self, value: &str) -> usize {
        ...
        count + self.count_escaped_chars_scalar(&value[offset..])
    }
