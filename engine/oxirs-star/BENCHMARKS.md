...
This document describes the comprehensive benchmarking suite for oxirs-star, including performance tests for v0.2.1 features and beyond.
...
### 3. Adaptive Benchmarks (`benches/adaptive_benchmarks.rs`) - NEW in v0.2.1
...
# Adaptive benchmarks (v0.2.1 features)
