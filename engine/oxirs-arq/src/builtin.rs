...
use std::str::FromStr;
use chrono::{DateTime, Utc, NaiveDateTime, TimeZone, Datelike};
use regex::Regex;
...
impl CustomFunction for IriFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#iri" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::Iri }
    fn documentation(&self) -> &str { "Constructs an IRI from a string" }
...
impl CustomFunction for UriFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#uri" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::Iri }
    fn documentation(&self) -> &str { "Alias for iri() function" }
...
impl CustomFunction for BlankFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#bnode" }
    fn arity(&self) -> Option<usize> { None } // 0 or 1 arguments
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::BlankNode }
    fn documentation(&self) -> &str { "Constructs a blank node" }
...
impl CustomFunction for LiteralFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#literal" }
    fn arity(&self) -> Option<usize> { None } // 1, 2, or 3 arguments
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::Literal }
    fn documentation(&self) -> &str { "Constructs a literal with optional language or datatype" }
...
impl CustomFunction for SubstrFunction {
    ...
    fn arity(&self) -> Option<usize> { None } // 2 or 3 arguments
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Returns a substring of a string" }
...
impl CustomFunction for UcaseFunction {
    ...
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Converts a string to uppercase" }
...
impl CustomFunction for LcaseFunction {
    ...
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Converts a string to lowercase" }
...
impl CustomFunction for EncodeForUriFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#encode-for-uri" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Encodes a string for use in a URI" }
...
impl CustomFunction for ReplaceFunction {
    ...
    fn arity(&self) -> Option<usize> { None } // 3 or 4 arguments
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Replaces occurrences of a pattern in a string" }
...
impl CustomFunction for RoundFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#round" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Float] }
    fn return_type(&self) -> ValueType { ValueType::Float }
    fn documentation(&self) -> &str { "Rounds a number to the nearest integer" }
...
impl CustomFunction for CeilFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#ceiling" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Float] }
    fn return_type(&self) -> ValueType { ValueType::Float }
    fn documentation(&self) -> &str { "Returns the ceiling of a number" }
...
impl CustomFunction for FloorFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#floor" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Float] }
    fn return_type(&self) -> ValueType { ValueType::Float }
    fn documentation(&self) -> &str { "Returns the floor of a number" }
...
impl CustomFunction for RandFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#random" }
    fn arity(&self) -> Option<usize> { Some(0) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::Float }
    fn documentation(&self) -> &str { "Returns a random number between 0 and 1" }
...
impl CustomFunction for NowFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#current-dateTime" }
    fn arity(&self) -> Option<usize> { Some(0) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::DateTime }
    fn documentation(&self) -> &str { "Returns the current date and time" }
...
impl CustomFunction for YearFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#year-from-dateTime" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::DateTime] }
    fn return_type(&self) -> ValueType { ValueType::Integer }
    fn documentation(&self) -> &str { "Extracts the year from a dateTime" }
...
impl CustomFunction for IsUriFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#isURI" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Literal] }
    fn return_type(&self) -> ValueType { ValueType::Boolean }
    fn documentation(&self) -> &str { "Alias for isIRI()" }
...
impl CustomFunction for IsBlankFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#isBlank" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Literal] }
    fn return_type(&self) -> ValueType { ValueType::Boolean }
    fn documentation(&self) -> &str { "Tests if a term is a blank node" }
...
impl CustomFunction for IsNumericFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#isNumeric" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Literal] }
    fn return_type(&self) -> ValueType { ValueType::Boolean }
    fn documentation(&self) -> &str { "Tests if a term is numeric" }
...
impl CustomFunction for IfFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#if" }
    fn arity(&self) -> Option<usize> { Some(3) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::Boolean, ValueType::Literal, ValueType::Literal] }
    fn return_type(&self) -> ValueType { ValueType::Literal }
    fn documentation(&self) -> &str { "Conditional expression" }
...
impl CustomFunction for CoalesceFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#coalesce" }
    fn arity(&self) -> Option<usize> { None } // Variadic
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::Literal }
    fn documentation(&self) -> &str { "Returns the first non-null argument" }
...
impl CustomFunction for RegexFunction {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#matches" }
    fn arity(&self) -> Option<usize> { None } // 2 or 3 arguments
    fn parameter_types(&self) -> Vec<ValueType> { vec![] }
    fn return_type(&self) -> ValueType { ValueType::Boolean }
    fn documentation(&self) -> &str { "Tests if a string matches a regular expression" }
...
impl CustomFunction for Md5Function {
    fn name(&self) -> &str { "http://www.w3.org/2005/xpath-functions#md5" }
    fn arity(&self) -> Option<usize> { Some(1) }
    fn parameter_types(&self) -> Vec<ValueType> { vec![ValueType::String] }
    fn return_type(&self) -> ValueType { ValueType::String }
    fn documentation(&self) -> &str { "Computes MD5 hash of a string" }
...
macro_rules! stub_function {
    ($name:ident, $iri:expr, $arity:expr, $doc:expr) => {
        ...
        impl CustomFunction for $name {
            fn name(&self) -> &str { $iri }
            fn arity(&self) -> Option<usize> { $arity }
            fn parameter_types(&self) -> Vec<ValueType> { vec![] }
            fn return_type(&self) -> ValueType { ValueType::String }
            fn documentation(&self) -> &str { $doc }
            fn clone_function(&self) -> Box<dyn CustomFunction> { Box::new(self.clone()) }
...
stub_function!(MonthFunction, "http://www.w3.org/2005/xpath-functions#month-from-dateTime", Some(1), "Extracts month from dateTime");
stub_function!(DayFunction, "http://www.w3.org/2005/xpath-functions#day-from-dateTime", Some(1), "Extracts day from dateTime");
stub_function!(HoursFunction, "http://www.w3.org/2005/xpath-functions#hours-from-dateTime", Some(1), "Extracts hours from dateTime");
stub_function!(MinutesFunction, "http://www.w3.org/2005/xpath-functions#minutes-from-dateTime", Some(1), "Extracts minutes from dateTime");
stub_function!(SecondsFunction, "http://www.w3.org/2005/xpath-functions#seconds-from-dateTime", Some(1), "Extracts seconds from dateTime");
stub_function!(TimezoneFunction, "http://www.w3.org/2005/xpath-functions#timezone-from-dateTime", Some(1), "Extracts timezone from dateTime");
stub_function!(TzFunction, "http://www.w3.org/2005/xpath-functions#tz", Some(1), "Returns timezone string");
stub_function!(Sha1Function, "http://www.w3.org/2005/xpath-functions#sha1", Some(1), "Computes SHA1 hash");
stub_function!(Sha256Function, "http://www.w3.org/2005/xpath-functions#sha256", Some(1), "Computes SHA256 hash");
stub_function!(Sha384Function, "http://www.w3.org/2005/xpath-functions#sha384", Some(1), "Computes SHA384 hash");
stub_function!(Sha512Function, "http://www.w3.org/2005/xpath-functions#sha512", Some(1), "Computes SHA512 hash");

stub_aggregate!(AvgAggregate, "http://www.w3.org/2005/xpath-functions#avg", "Computes average of numeric values");
stub_aggregate!(MinAggregate, "http://www.w3.org/2005/xpath-functions#min", "Finds minimum value");
stub_aggregate!(MaxAggregate, "http://www.w3.org/2005/xpath-functions#max", "Finds maximum value");
stub_aggregate!(GroupConcatAggregate, "http://www.w3.org/2005/xpath-functions#group-concat", "Concatenates group values");
stub_aggregate!(SampleAggregate, "http://www.w3.org/2005/xpath-functions#sample", "Returns sample value from group");