...
⚠️ **Release Candidate**: APIs may change without notice. Suitable for production alpha testing and internal deployments.
...
```toml
[dependencies]
oxirs-geosparql = { version = "0.1.0-rc.2", features = ["geos-backend"] }
```
