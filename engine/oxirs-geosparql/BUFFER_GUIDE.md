...
oxirs-geosparql = { version = "0.2.2", features = ["rust-buffer", "geos-backend"] }

# Or choose only one:
# oxirs-geosparql = { version = "0.2.2", features = ["rust-buffer"] }  # Pure Rust only
# oxirs-geosparql = { version = "0.2.2", features = ["geos-backend"] }  # GEOS only
```
...
```toml
oxirs-geosparql = { version = "0.2.2", features = ["rust-buffer"] }
```
