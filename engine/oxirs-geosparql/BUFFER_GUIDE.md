...
oxirs-geosparql = { version = "0.1.0-rc.2", features = ["rust-buffer", "geos-backend"] }

# Or choose only one:
# oxirs-geosparql = { version = "0.1.0-rc.2", features = ["rust-buffer"] }  # Pure Rust only
# oxirs-geosparql = { version = "0.1.0-rc.2", features = ["geos-backend"] }  # GEOS only
```
...
```toml
oxirs-geosparql = { version = "0.1.0-rc.2", features = ["rust-buffer"] }
```
...
**oxirs-geosparql Version**: 0.1.0-rc.2
