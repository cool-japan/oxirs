...
oxirs-geosparql = { version = "0.1.0-alpha.3", features = ["rust-buffer", "geos-backend"] }

# Or choose only one:
# oxirs-geosparql = { version = "0.1.0-alpha.3", features = ["rust-buffer"] }  # Pure Rust only
# oxirs-geosparql = { version = "0.1.0-alpha.3", features = ["geos-backend"] }  # GEOS only
```
