...
oxirs-geosparql = { version = "0.2.3", features = ["rust-buffer", "geos-backend"] }

# Or choose only one:
# oxirs-geosparql = { version = "0.2.3", features = ["rust-buffer"] }  # Pure Rust only
# oxirs-geosparql = { version = "0.2.3", features = ["geos-backend"] }  # GEOS only
```
