...
curl -LO https://github.com/cool-japan/oxirs/releases/download/v0.1.0-rc.2/oxirs-x86_64-linux.tar.gz
...
docker run -p 3030:3030 ghcr.io/cool-japan/oxirs-fuseki:v0.1.0-rc.2
...
services:
  oxirs-fuseki:
    image: ghcr.io/cool-japan/oxirs-fuseki:v0.1.0-rc.2
...
*Production-ready deployment for v0.1.0-rc.2*
