...
curl -L https://github.com/cool-japan/oxirs/releases/download/v0.1.0/oxirs-linux-x86_64.tar.gz | tar xz
...
# Server starts
# INFO  oxirs_fuseki: Starting OxiRS Fuseki Server v0.1.0
...
```bash
# Build image
docker build -t oxirs-fuseki:v0.1.0 .
