...
impl ControllerNetwork {
    pub fn new(input_size: usize, hidden_size: usize, output_size: usize) -> Self {
        ...
        let w_ih = Array2::from_shape_fn((hidden_size, input_size), |_| rng.gen_range(-0.1..0.1));
        let w_hh = Array2::from_shape_fn((hidden_size, hidden_size), |_| rng.gen_range(-0.1..0.1));
        let w_ho = Array2::from_shape_fn((output_size, hidden_size), |_| rng.gen_range(-0.1..0.1));
...
impl RelationalAttention {
    pub fn new(embed_dim: usize, num_heads: usize) -> Self {
        ...
        let query_weights = Array2::from_shape_fn((embed_dim, embed_dim), |_| rng.gen_range(-0.1..0.1));
        let key_weights = Array2::from_shape_fn((embed_dim, embed_dim), |_| rng.gen_range(-0.1..0.1));
        let value_weights = Array2::from_shape_fn((embed_dim, embed_dim), |_| rng.gen_range(-0.1..0.1));
