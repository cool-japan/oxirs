...
**Status**: Beta Release (v0.1.0-beta.2) - Released November 2025
...
- **HolE** - Holographic embeddings using circular correlation (NEW in v0.1.0-beta.2)
- **ConvE** - Convolutional 2D neural network embeddings (NEW in v0.1.0-beta.2)
- **TuckER** - Tucker decomposition for multi-relational learning
- **QuatE** - Quaternion embeddings for complex patterns

### Advanced Features (NEW in v0.1.0-beta.2)
...
oxirs-embed = { version = "0.1.0-beta.2", features = ["openai", "sentence-transformers"] }
```
