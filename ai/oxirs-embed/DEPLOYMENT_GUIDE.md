...
# Cargo.toml
[dependencies]
oxirs-embed = { version = "0.2.2", features = ["all"] }
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: oxirs-embed
        image: ghcr.io/cool-japan/oxirs-embed:0.2.2
        ports:
        - containerPort: 8080
          name: http
        - containerPort: 9090
...
wget https://github.com/cool-japan/oxirs/releases/download/v0.2.2/oxirs-embed-linux-x86_64.tar.gz
...
```bash
# Build Docker image
docker build -t oxirs-embed:0.2.2 .
