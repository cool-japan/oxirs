...
use scirs2_stats::ranking::RankingAlgorithm;
...
impl SuggestionEngine {
    ...
    fn followup_suggestions(&self, last_query: &str) -> Result<Vec<QuerySuggestion>> {
        let mut suggestions = Vec::new();

        // Suggest refinements
        suggestions.push(QuerySuggestion {
            text: format!("Refine the previous query"),
...
mod tests {
    ...
    fn test_followup_suggestions() {
        ...
        context.last_query = "Show me all movies".to_string();
