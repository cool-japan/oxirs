...
These modules are currently **prepared but disabled** because they require features from **scirs2-core 0.1.0-beta.4+** that are not yet available in the current **rc.2** version.
...
When scirs2-core 0.1.0-beta.4 (or later) is available:
...
| 0.1.0-beta.4 (future) | + gpu, tensor_cores, observability, full profiling |
