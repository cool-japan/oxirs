...
impl AnalyticsEngine {
    ...
    fn analyze_validation_patterns(
        ...
        if success_rate < 0.9 {
            insights.push(ValidationInsight {
                insight_type: crate::insights::ValidationInsightType::LowSuccessRate,
        ...
        for pattern in violation_patterns {
            insights.push(ValidationInsight {
                insight_type: crate::insights::ValidationInsightType::ViolationPattern,
        ...
        if !execution_times.is_empty() {
            ...
            if trend > 0.1 {
                insights.push(PerformanceInsight {
                    insight_type: crate::insights::PerformanceInsightType::DegradingPerformance,
    ...
    fn extract_key_findings(&self, insights: &ValidationInsights) -> Result<Vec<String>> {
        ...
        let degrading_performance: Vec<_> = insights
            .performance_insights
            .iter()
            .filter(|i| matches!(i.insight_type, crate::insights::PerformanceInsightType::DegradingPerformance))
            .collect();
