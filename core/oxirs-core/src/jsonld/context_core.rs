//! JSON-LD context processing algorithms.
//!
//! Implements the [Context Processing Algorithm](https://www.w3.org/TR/json-ld-api/#algorithm)
//! on [`JsonLdContextProcessor`], the [Create Term Definition](https://www.w3.org/TR/json-ld-api/#create-term-definition)
//! and [IRI Expansion](https://www.w3.org/TR/json-ld-api/#iri-expansion) algorithms,
//! plus the JSON event to [`JsonNode`] conversion helpers.

use super::context_types::{
    JsonLdContext, JsonLdContextProcessor, JsonLdLoadDocumentOptions, JsonLdTermDefinition,
    JsonNode,
};
