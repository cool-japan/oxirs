...
pub mod templates {
    use crate::{GraphQLConfig, validation::ValidationConfig, features::security::Environment};
    ...
    pub fn development_config() -> GraphQLConfig {
        ...
        config.validation_config = crate::features::security::SecurityPatterns::recommended_validation_config(Environment::Development);
        config
    }
    ...
    pub fn production_config() -> GraphQLConfig {
        ...
        config.validation_config = crate::features::security::SecurityPatterns::recommended_validation_config(Environment::Production);
        config
    }
    ...
    pub fn testing_config() -> GraphQLConfig {
        ...
        config.enable_playground = true;
        config.enable_introspection = true;
        config.validation_config = crate::features::security::SecurityPatterns::recommended_validation_config(Environment::Testing);
        config
    }
}