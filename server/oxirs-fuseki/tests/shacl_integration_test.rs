...
"#;
    ...
    let triples = TurtleParser::new().parse_str(turtle_data).unwrap();
...
async fn test_shacl_validation_fails() {
    ...
    let turtle_data = r#"@prefix ex: <http://example.org/> .
ex:Bob <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> ex:Person .
ex:Bob ex:age "25" .
"#;
...
// TODO: Re-enable when rdf-star feature is implemented
