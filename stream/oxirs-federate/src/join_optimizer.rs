//! Advanced Join Optimization - Modular Architecture
//!
...
//! ## Architecture
//!
//! The join optimizer is organized into specialized modules:
//! - `config`: Configuration management and tuning parameters
//! - `types`: Core data structures and algorithms
//! - `cost_model`: Cost estimation and modeling
//! - `adaptive`: Adaptive execution control
//! - `algorithms`: Specific optimization algorithms
...
use crate::{
    ...
    service_optimizer::{
        JoinPlan, JoinOperation, JoinOperationType, JoinAlgorithm, JoinEdge,
    },
    ServiceRegistry,
};
...
impl DistributedJoinOptimizer {
    ...
    async fn optimize_star_join(&self, graph: &JoinGraph, _registry: &ServiceRegistry) -> Result<JoinPlan> {
    ...
    async fn apply_adaptive_optimizations(&self, plan: JoinPlan, _registry: &ServiceRegistry) -> Result<JoinPlan> {
