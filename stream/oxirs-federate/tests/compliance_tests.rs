...
mod sparql_federation_compliance {
    ...
    async fn test_service_description_vocabulary() {
        ...
        assert!(registered_service.capabilities.contains(&ServiceCapability::SparqlQuery));
        assert!(registered_service.capabilities.contains(&ServiceCapability::SparqlUpdate));
    }
