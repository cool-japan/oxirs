...
## What's New in v0.1.0-beta.2 (November 2025)
...
cargo install oxirs --version 0.1.0-beta.2 --features all-features
```
...
**OxiRS CLI v0.1.0-beta.2** - Production-ready command-line interface for semantic web operations
