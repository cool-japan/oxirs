...
mod tests {
    ...
    fn test_encryption_roundtrip() {
        let config = EncryptionConfig::new("test-password-123");
    ...
    fn test_wrong_password_fails() {
        let config1 = EncryptionConfig::new("password1");
        let mut encryption1 = BackupEncryption::new(config1).unwrap();

        let config2 = EncryptionConfig::new("password2");
    ...
    fn test_serialization_roundtrip() {
        let config = EncryptionConfig::new("serialize-test");
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_file_encryption() {
        ...
        let config = EncryptionConfig::new("file-encryption-key");
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_compression_before_encryption() {
        let config = EncryptionConfig::new("compress-test").with_compression(true);
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_password_change() {
        let config = EncryptionConfig::new("old-password");
        let mut encryption = BackupEncryption::new(config).unwrap();
        ...
        let config_old = EncryptionConfig::new("old-password");
    ...
    fn test_multiple_encryptions_unique() {
        let config = EncryptionConfig::new("uniqueness-test");
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_large_data_encryption() {
        let config = EncryptionConfig::new("large-data-test");
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_custom_iterations() {
        let config = EncryptionConfig::new("iterations-test").with_iterations(100_000);
        let mut encryption = BackupEncryption::new(config).unwrap();
    ...
    fn test_encryption_without_compression() {
        let config = EncryptionConfig::new("no-compression").with_compression(false);
        let mut encryption = BackupEncryption::new(config).unwrap();
