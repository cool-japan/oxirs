//! DuckDB ↔ TSDB chunk bridge (feature-gated).
//!
//! This module is **only compiled when the `duckdb` feature is enabled**. It
//! provides zero-copy interoperability between TSDB time chunks and an
//! embedded DuckDB connection, using Apache Arrow `RecordBatch` as the
//! transport format.
//!
//! ## Direction overview
//!
